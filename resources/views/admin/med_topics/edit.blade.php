...
@section('title','تعديل موضوع')

@section('content')
<div class="d-flex align-items-center justify-content-between mb-3">
  <h1 class="h4 m-0">تعديل موضوع</h1>
  <a href="{{ route('admin.med_topics.index') }}" class="btn btn-light"><i class="bi bi-arrow-right"></i> رجوع</a>
</div>

<form action="{{ route('admin.med_topics.update',$topic) }}" method="POST" class="card p-3">
  @csrf @method('PUT')
  @include('admin.med_topics.form',['topic'=>$topic])
