            ...
            <div class="card-body">
                ...
                @if ($type === 'med_doctors')
                    <div class="alert alert-info">
                        ...
                        <div class="table-responsive mb-2">
                            <table class="table table-sm table-bordered mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>المواد<br><small><code>subject_ids</code></small></td>
                                        <td>قائمة المواد لربط الدكتور بها. اكتب معرفات المواد مفصولة بفواصل أو نقاط فاصلة (مثال: <code>1,2,3</code>) أو اكتب أسماء المواد مفصولة بفواصل/نقاط فاصلة (مثال: <code>تشريح,فسيولوجي</code>).
                                        </td>
                                        <td>لا</td>
                        ...
                        <p class="small text-muted">ملاحظة: يمكنك الآن ربط الدكاترة بالمواد خلال الاستيراد باستخدام عمود
                            <code>subject_ids</code>. يمكن أن يحتوي على معرفات المواد مفصولة بفواصل أو على أسماء المواد؛ سيتم محاولة
                            حل كل قيمة إما كمعرّف أو كاسم. القيم غير الموجودة سيتم تجاهلها وتظهر كتحذير في تقرير الاستيراد.</p>
                    </div>
                @endif
