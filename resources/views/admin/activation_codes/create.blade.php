...
<body class="p-3">
<div class="container">
  <h3 class="mb-3">إنشاء كود يدوي</h3>

  @if ($errors->any())
    <div class="alert alert-danger"><ul class="mb-0">@foreach ($errors->all() as $e)<li>{{ $e }}</li>@endforeach</ul></div>
  @endif

  <form method="post" action="{{ route('admin.activation-codes.store') }}" class="row g-3">
    @csrf
    <div class="col-md-6">
      <label class="form-label">code *</label>
      <input type="text" name="code" class="form-control" value="{{ old('code') }}" maxlength="64" required>
    </div>
    <div class="col-md-6">
      <label class="form-label">batch_id</label>
      <input type="number" name="batch_id" class="form-control" value="{{ old('batch_id') }}">
    </div>
    ...
    <div class="col-md-4">
      ...
      <input type="number" name="max_redemptions" class="form-control" value="{{ old('max_redemptions',1) }}" min="1" max="255" required>
    </div>
    <div class="col-md-4">
