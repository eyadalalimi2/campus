...
<div class="d-flex justify-content-between align-items-center mb-3">
  ...
  <div class="d-flex gap-2">
    <a href="{{ route('admin.users.edit', $user) }}" class="btn btn-primary btn-sm"><i class="bi bi-pencil"></i> تعديل</a>
      ...
      <div class="card-body">
        ...
        <div class="row mb-3">
          <div class="col-md-6">
            ...
            <div class="fw-semibold">{{ $user->gender ? ($user->gender==='male' ? 'ذكر' : 'أنثى') : '—' }}</div>
          </div>
          <div class="col-md-6">
        ...
        <div class="row mb-3">
          <div class="col-md-12">
            ...
            <div class="fw-semibold">
              ...
              @if($user->college) / {{ $user->college->name }} @endif
              @if($user->major) / {{ $user->major->name }} @endif
            </div>
          </div>
        </div>
