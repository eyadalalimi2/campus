<aside class="sidebar p-3">
    ...
    <nav class="sidebar-nav">
        ...
        <div class="nav-item">
            <a href="javascript:void(0)" class="nav-link {{ request()->is('admin/medical/systems*') ? 'active' : '' }}">
                <i class="bi bi-cpu"></i> الأجهزة
            </a>
        </div>
        <div class="nav-item">
            <a href="javascript:void(0)" class="nav-link {{ request()->is('admin/medical/subjects*') ? 'active' : '' }}">
                <i class="bi bi-journal-bookmark"></i> المواد
            </a>
        </div>
        <div class="nav-item">
            <a href="javascript:void(0)" class="nav-link {{ request()->is('admin/medical/doctors*') ? 'active' : '' }}">
