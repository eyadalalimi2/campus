        ...
        <div class="col-md-4">
          <div class="card h-100" style="border:0; box-shadow:0 6px 16px rgba(0,0,0,.06); border-radius:.75rem;">
            <div class="card-body">
              ...
              <a class="stretched-link" href="{{ route('admin.dashboard') }}"></a>
            </div>
          </div>
        </div>
      @endforeach
  ...
  <div class="container">
    <div class="row g-4 align-items-center">
      <div class="col-lg-6">
        ...
        <div class="d-flex gap-2">
          <a href="{{ route('admin.dashboard') }}" class="btn btn-primary">ابدأ الآن</a>
